...
provide technology consulting on the following 4 key areas: 1) design software architecture, 2) establish foundation data platform 3) practise responsible Machine learning operation , 4) govern cloud-native infrastructures
